...
<div class="live_edit_panel">
	...
	<form action="" method="post">
		<?php
			...
			$input = $_SESSION['live_option_input'][$option_name];
			foreach($input as $field_array){
				$args = array(
					'section'=>'live_option',
					'key'=>$field_array['name'],
				);
				$default_value = get_option($args);
				$field_array['handle'] = FALSE;
				$field_array['default_value'] = $default_value;
