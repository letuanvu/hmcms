    ...
    <div class="page_action">
      <div class="pull-left">
        ...
        <select class="search_order_by css_selectbox btn btn-default btn-xs">
          <?php
          echo '<option value="public_time">'.hm_lang('public_time').'</option>';
          echo '<option value="update_time">'.hm_lang('update_time').'</option>';
        ...
        <select class="search_order css_selectbox btn btn-default btn-xs">
          ...
          <option value="NUMASC"><?php echo hm_lang('small_to_large'); ?></option>
          <option value="NUMDESC" selected><?php echo hm_lang('big_to_small'); ?></option>
        </select>
